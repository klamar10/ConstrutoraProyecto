...
class DepartamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create departamento" do
    assert_difference('Departamento.count') do
      post departamentos_url, params: { departamento: { area: @departamento.area, caracteristicas: @departamento.caracteristicas, mantenis_id: @departamento.mantenis_id, piso: @departamento.piso, precio: @departamento.precio, tipo: @departamento.tipo } }
    end
  ...
  test "should update departamento" do
    patch departamento_url(@departamento), params: { departamento: { area: @departamento.area, caracteristicas: @departamento.caracteristicas, mantenis_id: @departamento.mantenis_id, piso: @departamento.piso, precio: @departamento.precio, tipo: @departamento.tipo } }
